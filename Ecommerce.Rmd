...
Generamos el mapa de calor con los datos transformados a logaritmos:
```{r}
...
Vamos a observar si podemos linealizar el precio final de la cesta a partir de el precio y la cantidad del producto.
```{r}
rl_data <- data %>%
...
```
Observamos que hay dos clusters de paises, el primer cluster incluye paises como: Australia, Irlanda, Francia, Alemania y Holanda. Básicamente paises vecinos (menos Australia) con los que es sencillo tener relaciones comerciales por su próximidad.
